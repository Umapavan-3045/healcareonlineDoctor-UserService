...
public class PatientController {
	...
	@GetMapping("/{id}")
	public ResponseEntity<ApiResponse<?>> getPatient(@PathVariable String id){
		try {
	...
	@PatchMapping("/update")
	public ResponseEntity<ApiResponse<String>> updatePatient(@RequestBody @Valid PatientDto pat){
